                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              <h4><i class="fa fa-angle-right"></i> Data Klinik</h4>
                              <hr>
                              <thead>
                              <tr>
                                  <th>Kode</th>
                              ...
                              <tr>
                                  ...
                                  <?php
                                  if( ! empty($klinik)){ // Jika data dokter tidak sama dengan kosong, artinya jika data dokter ada
                                    foreach($klinik as $data){
                                      echo "<tr>
                                      <td>".$data->kode_klinik."</td>
                                      <td>".$data->nama_klinik."</td>
                                      <td><a href='".base_url("klinik/ubah/".$data->kode_klinik)."'>Ubah ||</a>
                                      <a href='".base_url("klinik/hapus/".$data->kode_klinik)."'>Hapus</a></td>
                                      </tr>";
                                    }
                                  }else{ 
                          ...
                          <hr>
                            <a href='<?php echo base_url("klinik/tambah"); ?>'>Tambah Data</a><br><br>
                          </div><!-- /content-panel -->
                  </div><!-- /col-md-12 -->
              </div><!-- /row -->
