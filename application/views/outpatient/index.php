                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              <h4><i class="fa fa-angle-right"></i> Data Outpatient</h4>
                              <hr>
                              <thead>
                              <tr>
                                  <th>NIK</th>
                              ...
                              <tr>
                                  <?php
                                  if( ! empty($outpatient)){ // Jika data outpatient tidak sama dengan kosong, artinya jika data outpatient ada
                                    foreach($outpatient as $data){
                                      echo "<tr>
                                      <td>".$data->no_ktp."</td>
                                      <td>".$data->nama."</td>
                                      ...
                                      <td><a href='".base_url("outpatient/ubah/".$data->no_ktp)."'>Ubah || </a>
                                      <a href='".base_url("outpatient/hapus/".$data->no_ktp)."'>Hapus</a></td>
                                      </tr>";
                                    }
                                  }else{ // Jika data outpatient kosong
                          ...
                          <hr>
                            <a href='<?php echo base_url("outpatient/tambah"); ?>'>Tambah Data</a><br><br>
                          </div><!-- /content-panel -->
                  </div><!-- /col-md-12 -->
              </div><!-- /row -->
