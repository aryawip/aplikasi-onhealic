                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              <h4><i class="fa fa-angle-right"></i> Data Antrian</h4>
                              <hr>
                              <thead>
                              <tr>
                                <th>No Antrian</th>
                              ...
                              <tr>
                                <?php
                                if( ! empty($antrian)){ // Jika data antrian tidak sama dengan kosong, artinya jika data antrian ada
                                  foreach($antrian as $data){
                                    ...
                                    <td><a href='".base_url("antrian/ubah/".$data->no_antrian)."'>Ubah</a>
                                    <a href='".base_url("antrian/hapus/".$data->no_antrian)."'>Hapus</a></td>
                                    </tr>";
                                  }
                          ...
                          <hr>
                            <a href='<?php echo base_url("antrian/tambah"); ?>'>Tambah Data</a><br><br>
                          </div><!-- /content-panel -->
                  </div><!-- /col-md-12 -->
              </div><!-- /row -->
