            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Tambah Data Antrian</h4>
                      <div class="form-horizontal style-form">
                      <div style="color: red;"><?php echo validation_errors(); ?></div>
                            <?php echo form_open("antrian/tambah"); ?>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No Antrian</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="input_no"  value="<?php echo set_value('input_no'); ?>">
                              </div>
                              </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="input_pasien" value="<?php echo set_value('input_pasien'); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jam Periksa</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_jam" value="<?php echo set_value('input_jam'); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Status</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="input_status" value="<?php echo set_value('input_status'); ?>">
                              </div>
                            </div>
