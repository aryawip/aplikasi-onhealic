                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              <h4><i class="fa fa-angle-right"></i> Data Dokter</h4>
                              <hr>
                              <thead>
                              <tr>
                                  <th>Id</th>
                              ...
                              <tr>
                                  ...
                                  if( ! empty($dokter)){ // Jika data dokter tidak sama dengan kosong, artinya jika data dokter ada
                                    foreach($dokter as $data){
                                      ...
                                      <td><a href='".base_url("dokter/ubah/".$data->id_dokter)."'>Ubah || </a>
                                      <a href='".base_url("dokter/hapus/".$data->id_dokter)."'>Hapus</a></td>
                                      </tr>";
                                    }
                          ...
                          <hr>
                            <a href='<?php echo base_url("dokter/tambah"); ?>'>Tambah Data</a><br><br>
                          </div><!-- /content-panel -->
                  </div><!-- /col-md-12 -->
              </div><!-- /row -->
