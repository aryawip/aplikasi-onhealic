            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Ubah Data Dokter</h4>
                      <div class="form-horizontal style-form">
                      <div style="color: red;"><?php echo validation_errors(); ?></div>
                            <?php echo form_open("dokter/ubah/".$dokter->id_dokter); ?>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Id</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="input_id" value="<?php echo set_value('input_id', $dokter->id_dokter); ?>" readonly>
                              </div>
                              </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="input_nama" value="<?php echo set_value('input_nama', $dokter->nama_dokter); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Senin</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_senin" value="<?php echo set_value('input_senin', $dokter->senin); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Selasa</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_selasa" value="<?php echo set_value('input_selasa', $dokter->selasa); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Rabu</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_rabu" value="<?php echo set_value('input_rabu', $dokter->rabu); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kamis</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_kamis" value="<?php echo set_value('input_kamis', $dokter->kamis); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumat</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_jumat" value="<?php echo set_value('input_jumat', $dokter->jumat); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Sabtu</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_sabtu" value="<?php echo set_value('input_sabtu', $dokter->sabtu); ?>"></td>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Minggu</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_minggu" value="<?php echo set_value('input_minggu', $dokter->minggu); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <a href="<?php echo base_url('dokter'); ?>"><input type="button" value="Batal" class="btn btn-theme"></a>
                          <?php echo form_close(); ?>
                    </div>
                  </div>
              </div><!-- col-lg-12-->       
