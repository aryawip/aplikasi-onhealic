            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Tambah Data Dokter</h4>
                      <div class="form-horizontal style-form">
                      <div style="color: red;"><?php echo validation_errors(); ?></div>
                            <?php echo form_open("dokter/tambah"); ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_senin" value="<?php echo set_value('input_senin'); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_rabu" value="<?php echo set_value('input_rabu'); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kamis</label>
                              <div class="col-sm-10">
                                 <input type="time" class="form-control" name="input_kamis" value="<?php echo set_value('input_kamis'); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumat</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_jumat" value="<?php echo set_value('input_jumat'); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Sabtu</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_sabtu" value="<?php echo set_value('input_sabtu'); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Minggu</label>
                              <div class="col-sm-10">
                                  <input type="time" class="form-control" name="input_minggu" value="<?php echo set_value('input_minggu'); ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Klinik</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="input_klinik" value="<?php echo set_value('input_klinik'); ?>">
                              </div>
                            </div>
